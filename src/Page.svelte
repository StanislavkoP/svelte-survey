<script>
	...
	function radioChange(e, element) {

			element.otherIsSelected = !element.otherIsSelected;
				...
				{#if element.type === 'radiogroup'}
					{#each element.choices as choice, i}
						<div class="question__group question__group--radio">
							<input
								id={`page-${page.countPage}-input${i}`}
							...
							/>
							<label
								for={`page-${page.countPage}-input${i}`}
					...
					{#if element.hasOther}
						<div class="question__group question__group--radio">
							<input
								...
								name={element.name}
								value="native-other"
								on:change={(e) => radioChange(e, element)}
								bind:group={element.value} 
							/>
							<label
